"""Main script of package: Parses a markdown file. Entry point"""
...
def parse(file_str: str, urls_fpath='', verbose=False, l_regexes=l_regexes):
...
def main():
    ...
    file_str = parse(file_str=file_str,
